package com.emate.shop.business.constants;


import java.util.ArrayList;
import java.util.List;

import com.emate.shop.rpc.dto.PageInfo;
...
public class PaginationUtil {
    ...
    public PaginationUtil(int num, int size, int rowCount) {
        this.num = num;
        this.size = size;
    ...
    public PageInfo createPageInfo(){
		...
		pageInfo.setPageIndex(this.num);
		pageInfo.setPageSize(this.size);
		pageInfo.setRecordCount(this.rowCount);
		return pageInfo;
    }
