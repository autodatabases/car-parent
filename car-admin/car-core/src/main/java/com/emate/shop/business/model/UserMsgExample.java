...
public class UserMsgExample {
    ...
    public static final String MSG_TITLE_ASC = "msg_title asc";

    public static final String MSG_TITLE_DESC = "msg_title desc";

    public static final String MGS_CONTENT_ASC = "mgs_content asc";

    public static final String MGS_CONTENT_DESC = "mgs_content desc";
