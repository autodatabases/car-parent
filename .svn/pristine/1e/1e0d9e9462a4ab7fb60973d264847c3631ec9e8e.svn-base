...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${_RESOURCES}/css/oilCard/mobile.css?v=${_version}&t=1.2" />
	...
	<script src="${_RESOURCES}/js/oilCard/mobile.js?v=${_version}&t=1.3" type="text/javascript" charset="utf-8"></script>
</head>
...
<body>
	...
	<div class="content" style="margin-top: 0.5rem">
		...
		<div class="allToalout">
			<div class="allToal">
				<div class="phoneRe headActive">话费充值</div>
				<div class="flowRe">流量充值</div>
			</div>
		</div>
		<div class="info">
			<div>
				<span>手机号码</span>
				<div style="width: 74%;border-bottom: 1px solid #ccc;float: left;height: 3rem;">
					<input type="tel" id="mobile" placeholder="请输入手机号码" data-type="1" maxlength="11" />
					<a id="area"></a>
				</div>
			</div>
			<p style="color:red;font-size:12px;padding:0 2rem;">温馨提示：请认真核对充值手机号，对个人输入有误产生的售后问题概不受理。</p>
		</div>
		<div class="money">
			<div>
				<p>请选择充值金额</p>
		...
		<div class="flowMoney">
			...
			<div>
				<input type="button" id="flowBtn" value="立即充值" />
			</div>
		</div>
		<div class="rechargeTg">
			<h4 style="padding-top: 1rem;font-weight: normal;">充值说明</h4>
			<p>1.所有流量都是全国流量，不限地区使用；</p>
			<p>2.充值成功后即时生效；</p>
			<p>3.购买流量月底失效，次月不会累积；</p>
		</div>
	</div>
	<div class="tip">
		<div class="bg"></div>
