...
/*			String phone = (String)next.get("phone");
  ...
  //update数据库import_user_info
    ...
    public static List<String> queryOilOrders() throws Exception {
    	DBHelper db = new DBHelper("select order_no from oil_orders where order_status = 1 and charge_type = 3 and user_id = 4");
    	ResultSet  ret = db.pst.executeQuery();
    	List<String> orderNoList = new ArrayList<String>();
        while (ret.next()) {  
            String orderNo = ret.getString(1);
