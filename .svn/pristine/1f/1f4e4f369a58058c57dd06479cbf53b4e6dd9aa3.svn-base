...
public interface OilUserService {
    ...
    public DatasetSimple<String> chargeOilCard(Long userId, String oilCardNo,
            String money, String goodId, String mobile, String cardType,
            String ip);
    ...
    public DatasetSimple<String> chargeMobilePhone(Long userId, String phone,
            String money,String userIp);
     ...
     */
    public void ofPhoneBack(String ret_code, String err_msg, String sporder_id,
     ...
     * @param ordersuccesstime
     */
    public void ofOilBack(String ret_code, String err_msg, String sporder_id,
            String ordersuccesstime);
