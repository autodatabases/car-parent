	...
	<div class="content">
		...
		<div class="operate">
			<ul>
				...
				<li class="mobile">手机充值</li>
				<li class="cateyes">猫眼电影</li>
				<li class="didi">滴滴出行</li>
				<li class="videoCard">视频会员卡</li>
		...
		<div class="phone phone1">
			客服热线：
			<a style="color:#ff3e5b;" href="javascript:void(0)">400-867-1993</a>
			<span>(服务时间：周一至周日)</span>
		</div>
		<!-- <div class="phone phone2">
				客服热线Ⅱ：<a style="color:#ff3e5b;" href="javascript:void(0)">400-867-1993</a><span>(服务时间：周六、周日)</span>
			</div> -->
	</div>
	<div class="tip tip1">
		<div class="bg"></div>
		<div class="tipCon">
			...
			<div class="cont">
				...
				<p>服务时间为周一至周日(节假日除外)，上午9:00-12:00,下午13:00-18:00</p>
			</div>
			<div class="btnCon">
