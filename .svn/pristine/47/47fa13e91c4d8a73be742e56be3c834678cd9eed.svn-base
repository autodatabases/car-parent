package com.emate.shop.wechat.controller.weixin.media;
...
public class MUDload {
	...
	public static void main(String[] args) {
		 ...
		 * 上传多媒体文件
		 */
		String access_token = WeixinUtil.getAccessToken(ParamesAPI.getCorpId(ParamesAPI.DEFAULT_SYSID), ParamesAPI.getSecret(ParamesAPI.DEFAULT_SYSID)).getToken();
		//地址
