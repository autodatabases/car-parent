<#include "/commons/header.ftl" />
	...
	<script src="${_RESOURCES}/js/business/bindBusiness.js?v=${_version}" type="text/javascript" charset="utf-8"></script>
</head>
<body>
	<header class="header">
	...
	<div class="forms">
		...
		<input type="number" name="" onkeyup="maxValue(8,this)" id="businessCode" placeholder="请输入工号"/>
	</div>
