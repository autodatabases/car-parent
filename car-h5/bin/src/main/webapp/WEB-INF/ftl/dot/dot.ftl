	<#include "../commons/header.ftl" />
		...
		<script src="${_RESOURCES}/js/dot/dot.js?v=${_version}" type="text/javascript" charset="utf-8"></script>
		...
		<dl class="tab-list" id="dot_dl">
			<dt>
				...
				<div>
					...
					<span id="selectStore" value="">所有门店</span>
				</div>
				<div>
					<!--<select id="orderType">
					...
					<span id="selectDefalt" value="score">默认排序</span>
				</div>
